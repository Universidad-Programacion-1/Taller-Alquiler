...
public class App extends Application {
    ...
    public void onOpenCrudMoto() {
        try {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(App.class.getResource("crudMoto.fxml"));
            AnchorPane rootLayout = (AnchorPane) loader.load();
    ...
    public void onOpenCrudAlquiler() {
        try {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(App.class.getResource("crudAlquiler.fxml"));
            AnchorPane rootLayout = (AnchorPane) loader.load();
